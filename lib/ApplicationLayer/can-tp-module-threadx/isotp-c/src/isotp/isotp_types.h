...
#include <stdbool.h>
#include <stdio.h>
#define PEGASUS_CANTP


#ifdef STARK_CANTP
#define MAX_ISO_TP_MESSAGE_SIZE 1024
#define OUR_MAX_ISO_TP_MESSAGE_SIZE 1024
#endif 
#ifdef MARK_CANTP
#define MAX_ISO_TP_MESSAGE_SIZE 260
#define OUR_MAX_ISO_TP_MESSAGE_SIZE 260
#endif
#ifdef MARVEL_CANTP
#define MAX_ISO_TP_MESSAGE_SIZE 1024
#define OUR_MAX_ISO_TP_MESSAGE_SIZE 1024
...
typedef bool (*SendCanMessageShim)(const uint32_t arbitration_id,
        uint8_t* data, const uint8_t size);
