...
void Pegasus_MBD_initialize(void)
{
  ...
  rtU.Thresholds.Iq_max_limit_A = 200.0;
  rtU.Thresholds.Iq_min_limit_A = -200.0;
  ...
  rtU.Thresholds.MaxCurrentLimit_A = 200.0;
  ...
  rtU.Thresholds.OCWarningLimit_A = 150.0;
  rtU.Thresholds.OCErrorLimit_A = 200.0;
