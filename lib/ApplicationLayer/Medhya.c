...
void Medhya_step(void)
{
  ...
  /* Matfile logging */
  rt_UpdateTXYLogVars(Medhya_M->rtwLogInfo, (&Medhya_M->Timing.taskTime0));

  /* signal main to stop simulation */
  {                                    /* Sample time: [1.0E-6s, 0.0s] */
    if ((rtmGetTFinal(Medhya_M)!=-1) &&
        !((rtmGetTFinal(Medhya_M)-Medhya_M->Timing.taskTime0) >
          Medhya_M->Timing.taskTime0 * (DBL_EPSILON))) {
      rtmSetErrorStatus(Medhya_M, "Simulation finished");
    }
  }
   ...
   */
  if (!(++Medhya_M->Timing.clockTick0)) {
    ++Medhya_M->Timing.clockTickH0;
  }

  Medhya_M->Timing.taskTime0 = Medhya_M->Timing.clockTick0 *
    Medhya_M->Timing.stepSize0 + Medhya_M->Timing.clockTickH0 *
    Medhya_M->Timing.stepSize0 * 4294967296.0;
}
...
void Medhya_initialize(void)
{
  ...
  (void) memset((void *)Medhya_M, 0,
                sizeof(RT_MODEL_Medhya_T));
  rtmSetTFinal(Medhya_M, 0.15);
  Medhya_M->Timing.stepSize0 = 1.0E-6;

  /* Setup for data logging */
  {
    static RTWLogInfo rt_DataLoggingInfo;
    rt_DataLoggingInfo.loggingInterval = (NULL);
    Medhya_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(Medhya_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(Medhya_M->rtwLogInfo, (NULL));
    rtliSetLogT(Medhya_M->rtwLogInfo, "tout");
    rtliSetLogX(Medhya_M->rtwLogInfo, "");
    rtliSetLogXFinal(Medhya_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(Medhya_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(Medhya_M->rtwLogInfo, 2);
    rtliSetLogMaxRows(Medhya_M->rtwLogInfo, 0);
    rtliSetLogDecimation(Medhya_M->rtwLogInfo, 1);
     ...
     */
    {
      static void * rt_LoggedOutputSignalPtrs[] = {
        &Medhya_Y.G[0],
        &Medhya_Y.ManualPos,
        &Medhya_Y.ThetaSensed,
        &Medhya_Y.IdqFeedback[0],
        &Medhya_Y.VdControl,
        &Medhya_Y.VqControl,
        &Medhya_Y.ModWave[0],
        &Medhya_Y.IdRef_out,
        &Medhya_Y.IqRef_out,
        &Medhya_Y.TorqueCalc,
        &Medhya_Y.SpeedRef_out
      };

      rtliSetLogYSignalPtrs(Medhya_M->rtwLogInfo, ((LogSignalPtrsType)
...

    {
      ...
      rtliSetLogYSignalInfo(Medhya_M->rtwLogInfo, rt_LoggedOutputSignalInfo);
    ...
    rtliSetLogY(Medhya_M->rtwLogInfo, "yout");
  }
  ...
  /* Matfile logging */
  rt_StartDataLoggingWithStartTime(Medhya_M->rtwLogInfo, 0.0, rtmGetTFinal
    (Medhya_M), Medhya_M->Timing.stepSize0, (&rtmGetErrorStatus(Medhya_M)));
  ...
  Medhya_U.EnableVdVqControl =0.0;

  Medhya_U.ManualSpeedRef = 1000.0;
  Medhya_U.IdRef = -50.0;
  Medhya_U.IqRef = 50.0;

  Medhya_U.ManualPositionOffset = -0.523598776;
  
  Medhya_U.VdRefManual = -6.0;
  Medhya_U.VqRefManual = 9.0;
