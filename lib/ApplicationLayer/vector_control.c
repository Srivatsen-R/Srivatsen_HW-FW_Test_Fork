...
{
    foc.pwm_a = (uint16_t)((PWM_CONST_2*((FOC_Y.Va / 61.0) * 30000.0))  + PWM_CONST_1);
    foc.pwm_b = (uint16_t)((PWM_CONST_2*((FOC_Y.Vb / 61.0) * 30000.0))  + PWM_CONST_1);
    foc.pwm_c = (uint16_t)((PWM_CONST_2*((FOC_Y.Vc / 61.0) * 30000.0))  + PWM_CONST_1);   
